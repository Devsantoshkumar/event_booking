                ...
                <?php $this->view('admin-includes/topbar'); ?>
                   ...
                   <div class="row p-4">
                    <div class="col d-flex justify-content-between align-items-center">
                      <span class="pageHeading fs-5">Update States</span>
                      <div class="actionBtns d-flex justify-content-center align-items-center">
                        ...
                        <a href="<?=ROOT ?>/states" class="add text-decoration-none rounded d-flex justify-content-center align-items-center text-light mx-2"><span class="material-symbols-sharp">visibility</span></a>
                  ...
                  <div class="row">
                    ...
                    <div class="card px-5 bg-transparent rounded-0 border-0">
                      <div class="card-body">
                        ...
                        <div class="card-header border-0 bg-white text-muted h3 fw-bold text-center">Update State</div>
                        <?php if($row): ?>
                           <div class="card-body px-5">
                              <form method="POST" enctype="multipart/form-data">
                              
                              <div class="input-group mb-3">
                                  <input type="text" name="state" class="form-control shadow-none" value="<?=$row[0]->state; ?>">
                              </div>
