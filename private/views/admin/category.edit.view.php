                ...
                <?php $this->view('admin-includes/topbar'); ?>
                   ...
                   <div class="row p-4">
                    <div class="col d-flex justify-content-between align-items-center">
                      <span class="pageHeading fs-5">Update Category</span>
                      ...
                      <div class="card-body">
                        ...
                        <?php if($row): ?>
                           <div class="card-body px-5">
                              ...
                              <div class="input-group mb-3">
                                  <textarea name="description" class="form-control shadow-none" placeholder="Description"><?=$row[0]->description; ?></textarea>
                              </div>

                              <div class="input-group mb-3">
                              <input type="text" name="meta_keywords" class="form-control shadow-none" value="<?=$row[0]->meta_keywords; ?>">
                              </div>

                              <div class="input-group mb-3">
                                  <textarea name="meta_description" class="form-control shadow-none"><?=$row[0]->meta_description; ?></textarea>
                              </div>
