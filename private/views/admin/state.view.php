                ...
                <?php $this->view('admin-includes/topbar'); ?>
                   ...
                   <div class="row p-4">
                    <div class="col d-flex justify-content-between align-items-center">
                      <span class="pageHeading fs-5">All Countries</span>
                      <div class="actionBtns d-flex justify-content-center align-items-center">
                        ...
                        <a href="<?=ROOT ?>/states/add" class="add text-decoration-none rounded d-flex justify-content-center align-items-center text-light mx-2"><span class="material-symbols-sharp">add</span></a>
                    ...
                    <div class="col">
                          <div class="card px-3 bg-transparent rounded-0 border-0">
                            <div class="card-body py-0">
                              ...
                              <div class="card-header border-0 bg-white h5 text-uppercase fw-bold text-center">All Countries</div>
                                ...
                                <?php if($rows) : ?>
                                    <table class="table">
                                        ...
                                        <tr>
                                          ...
                                          <td><?=$row->status; ?></td>
                                          <td>
                                            <a href="<?=ROOT ?>/states/edit/<?=$row->states_id ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?=ROOT ?>/states/delete/<?=$row->states_id ?>" class="btn btn-sm btn-danger">Delete</a>
                                          </td>
                                        </tr>
                                        <?php $cid++; ?>
                                        <?php endforeach; ?>
                                    ...
                                    <?php else:  ?>
                                      <div class="h5 text-center bg-danger text-white p-3">Data not found</div>
                                    <?php endif; ?>
                                </div>  
                              </div>
                            </div>
